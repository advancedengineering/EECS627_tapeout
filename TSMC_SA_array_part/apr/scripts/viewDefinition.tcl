...
### Added by Qianhao
create_delay_corner -name Delaytyp -library_set typLib -rc_corner typRC
### end
...
### Added by Qianhao
create_analysis_view -name Analysistyp -constraint_mode typConst -delay_corner Delaytyp
### end
