...
restoreDesign db/final.dat shifter 

## Output power
read_activity_file -format VCD /afs/umich.edu/class/eecs627/w23/groups/group3/TOP/sim.dump.vcd -scope testbench/shift0
report_vector_profile -average_power -step 1ns -propagate -write_profiling_db true
report_power -outfile ${REPORT_PATH}/Shifter.power.rpt
exit
