...
set init_lef_file        [list \
                        ...
                        ${LEF_DIR}/controller.lef \
                        ${LEF_DIR}/shifter.lef \
                        ${LEF_DIR}/SA_array_part.lef \
                        ${LEF_DIR}/write_back_part.lef \
                        ${LEF_DIR}/sram.plef \
                        ${LEF_DIR}/Ring.lef
                        # /afs/umich.edu/class/eecs627/w23/groups/group3/TSMC_Controller_changed/apr/controller.lef \
                        # /afs/umich.edu/class/eecs627/w23/groups/group3/TSMC_Shifter/apr/shifter.lef \
                        # /afs/umich.edu/class/eecs627/w23/groups/group3/TSMC_SA_array_part_port_changes/apr/SA_array_part.lef \
                        # /afs/umich.edu/class/eecs627/w23/groups/group3/TSMC_write_back_tgc_lzc/apr/write_back_part.lef \
                        # /afs/umich.edu/class/eecs627/w23/groups/group3/TSMC_SRAM/sram.plef
                    ]
set typ_lib_file    [list \
                        ${sc_dir}/typical.lib \
                        $LIB_DIR/controller.lib \
                        $LIB_DIR/shifter.lib \
                        $LIB_DIR/SA_array_part.lib \
                        $LIB_DIR/write_back_part.lib \
                        $LIB_DIR/sram.lib \
                        $LIB_DIR/Ring.lib
                        # /afs/umich.edu/class/eecs627/w23/groups/group3/TSMC_Shifter/apr/shifter.lib \
                        # /afs/umich.edu/class/eecs627/w23/groups/group3/TSMC_Controller_changed/apr/controller.lib \
                        # /afs/umich.edu/class/eecs627/w23/groups/group3/TSMC_SA_array_part_port_changes/apr/SA_array_part.lib \
                        # /afs/umich.edu/class/eecs627/w23/groups/group3/TSMC_write_back_tgc_lzc/apr/write_back_part.lib \
                        # /afs/umich.edu/class/eecs627/w23/groups/group3/TSMC_SRAM/Typical/sram.lib
                    ]
