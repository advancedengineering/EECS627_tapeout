...
# Read verilog files
#/afs/umich.edu/class/eecs627/w23/groups/group3/pad_gen_template/verilog/TOP_chip.v \
#/afs/umich.edu/class/eecs627/w23/groups/group3/pad_gen_template/verilog/TOP_pads.v"
read_file -f sverilog " ../verilog/standard.vh \
                  /afs/umich.edu/class/eecs627/w23/groups/group3/TOP/verilog/define.vh \
                  /afs/umich.edu/class/eecs627/w23/groups/group3/TOP/verilog/TOP.sv"
...
# }
  ...
  #If no waveform is specified, 50% duty cycle is assumed
  #create_clock -name $clk_name -period $clk_period [get_ports $clk_port]
   create_clock -name $clk_name -period $clk_period [get_pins clk_gen/clk]
  #get_net block_name/clk
  set_drive 0 [get_clocks $clk_name] 
...
set_dont_touch {c0 shift0 SA_p0 WB_p0 sram0 sram1 clk_gen}
# Link the design
link
...
write_sdc -nosplit -version 2.0 "${top_level}.syn.sdc"
